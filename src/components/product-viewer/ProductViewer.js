...
import {Button, Chip, Rating} from "@mui/material";
    import CartCountController from "../cart-count-controller/CartCountController";
...
const ProductViewer = () => {
    ...
    return (
        <div className="product-viewer container">
            <div className="row">
                <div className="product-image-holder col-lg-6 col-md-6">
                    ...
                    <div className="other-image-holder">
                        ...
                        >
                            <div className="item">
                                <div className="sec-image-holder">
                ...
                <div className="product-detail-holder col-lg-6 col-md-6">
